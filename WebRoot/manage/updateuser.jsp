...
<body>
	${message}
	<a href="${pageContext.request.contextPath}/">返回后台首页</a>
	<h1 align="center">输入注册信息</h1>
	<div class="form_content">
		<form name="regForm" onSubmit="return check()" action="${pageContext.request.contextPath}/manage/updateuser.do"
			method="post">
			<fieldset>
				<div class="form-row">
				...
				<div class="form-row">
					<div class="field-label">权限：</div>
					<div class="field-widget">
						<input type="text" name="ulimit" value="${updateuser.ulimit}" />
					</div>
				</div>
				...
				<div class="form-row">
					...
					<div class="field-widget">
						<input type="text" name="num" value="${updateuser.num}"/>
					</div>
				</div>
